...
<div id="container" >
	...
	<div id="menu" >
		...
		<?php if(isset($_SESSION['zalogowany'])) echo '<div class="menubutton" ><a href="movies.php">Dodaj film</a></div><div class="menubutton" ><a href="my_movies.php">Moje filmy</a></div>';
		?>
